...
('002',	'Williams',	'Sarah',	7,	'Clarinet',	'7834'),
...
CREATE TABLE GUARDIAN (
	...
	LName			varchar(25),
	FName			varchar(25),
	WaiverSigned	varchar(1),
	primary key (Phone, CompetitorID),
	foreign key (CompetitorID) references COMPETITOR(CompetitorID)
);

INSERT INTO GUARDIAN (Phone, CompetitorID, LName, FName, WaiverSigned)
VALUES
('403-644-7344', '001',	'Williams',	'Adele', 'N'),
('403-644-7344', '002',	'Williams',	'Adele', 'N'),
('587-231-2955', '157',	'Lavoie',	'Emmy',	'Y'),
('587-860-4663', '052',	'Turner',	'Jackson',	'N'),
('403-386-2169', '188',	'Wong',	'	May', 'Y'),
('403-646-1876', '133',	'Sherman',	'Oliver',	'N'),
('587-485-8596', '110',	'Torres',	'Mariana',	'Y'),
('403-124-3891', '045',	'Reid',		'Aria', 'Y'),
('403-344-9873', '096',	'Madani',	'Ahmad', 'Y');
...
VALUES
('001',	'Classical',	'5',	'11',	'2023-12-01',	'10:00'),
('002',	'Classical',	'12',	'18',	'2023-12-01',	'13:00'),
('003',	'Romantic',	'5',	'11',	'2023-12-02',	'10:00'),
('004',	'Romantic',	'12',	'18',	'2023-12-02',	'13:00'),
('005',	'Baroque',	'5',	'11',	'2023-12-03',	'10:00'),
('006',	'Baroque',	'12',	'18',	'2023-12-03',	'13:00'),
('007',	'Modern',	'5',	'11',	'2023-12-04',	'10:00'),
('008',	'Modern',	'12',	'18',	'2023-12-04',	'13:00');


DROP TABLE IF EXISTS PERFORMANCE;
CREATE TABLE PERFORMANCE (
	CompetitorID	char(3)	not null,TEACHER
	CategoryID		char(3) not null,
	MusicID			char(2) not null,
	Score			integer,
